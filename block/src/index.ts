...
export type DimensionalityReductionBlockContract = BlockContract;
export type DimensionalityReductionBlockOutputs  = BlockOutputs;
export type DimensionalityReductionBlockData     = BlockData;
export const DimensionalityReductionBlockPointer = BlockPointer;
